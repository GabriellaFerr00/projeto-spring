...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order order1 = new Order(null, Instant.parse("2023-03-20T19:53:07Z"), user1);
        Order order2 = new Order(null, Instant.parse("2023-03-21T03:42:10Z"), user2);
        Order order3 = new Order(null, Instant.parse("2023-03-22T15:21:22Z"), user1);
